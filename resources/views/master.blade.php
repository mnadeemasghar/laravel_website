        ...
        <div class="collapse navbar-collapse mx-auto pr-5 " id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-md-3 mx-auto ">
                <li class="nav-item d-inline-block d-lg-none">
                    <a class="nav-link " href="Registernow" data-offset="90">Sign Up</a>
                </li>
                <li class="nav-item d-inline-block d-lg-none">
                    <a class="nav-link " href="Login" data-offset="90">Login-M</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/Home/Faq" data-offset="90">FAQ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/Home/Contact" data-offset="90">Contact</a>
                </li>
            </ul>
            <ul class="navbar-nav nav-flex-icons loginitems px-2 d-none d-md-flex">
                <li class="nav-item">
                    <a class="nav-link navregister" href="/Registernow" data-offset="90">Sign Up</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link navregister" href="/Login" data-offset="90">Login</a>
                </li>
            </ul>
        </div>
    </nav>
